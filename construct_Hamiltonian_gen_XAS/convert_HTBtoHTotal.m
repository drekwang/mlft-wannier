function [HTotal,binaryindices] = convert_HTBtoHTotal(...
    HTB,numorbitals,numelectrons)
    %Converts HTB from single-particle to many-body basis
    TM3dindices = 1:10;
    L2pindices = 11:46;
    TM2pindices = 47:52;
    ...
    for bra = 1:numstates
        %Only calculate the diagonal and upper triangle to halve calc timeHTotal
